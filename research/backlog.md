...
**Status:** Drafted in `src/content/posts/verification-gate-needs-a-name.en.md` on 2026-08-20 (PR #104), superseding PR #62 (`physics-not-permission`, downgraded Essay→Note on 2026-08-14), which was closed 2026-08-21 after exceeding the 14-day open-PR clock while drifted into a merge conflict with `main`. PR #104 was independently drafted from the same interview and, per an author Desk downgrade comment on 2026-08-24, trimmed to a single field-note claim (`docs/pipeline.md` §10 / `docs/material-form.md` §7) rather than the accountability-vs-domain synthesis PR #62 also carried.
