...
| consequence gate | 问责关卡 | Coined in the "physics gate is actually an accountability gate" note: a verification step no agent output can skip, that exists because a named person answers for the failure, not because the check is technically hard. |
