...
| embodied intelligence | 具身智能 | Keep "embodied intelligence" in English and 具身智能 in Chinese on first mention; the piece's own test (below) is what qualifies a product for the term, not marketing usage. |
| removal test ("pull it out and see what's left") | 减法测试 | Coined as 减法测试 in the zh title of "AI-native game is a test" and reused here for embodied intelligence; English stays descriptive ("pull the intelligence out and see what changes") rather than a fixed English name — keep that asymmetry rather than forcing a matching English term. |
