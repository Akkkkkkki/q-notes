...
Compare that to games people actually remember. GTA, the Witcher, Baldur's Gate 3: the writers built one specific, coherent thing instead of the average of everything a story like that could be. Baldur's Gate 3 is the case that ought to settle it. Larian shipped [something like 17,000 variations on the ending](https://www.pcgamer.com/baldurs-gate-3-has-17000-variations-on-its-ending-a-number-that-gives-me-a-headache-just-thinking-about-it/), and the striking part isn't the number. It's that writers sat and wrote them, for over a year. Maximum variety, zero averaging. Those games feel real because someone decided what belongs and what doesn't. A system trained to satisfy the widest expectation has no reason to make that call.
