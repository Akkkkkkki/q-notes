...
软件里其实也有一道差不多的关卡，只是不在 DAC 故事讲的地方。航空软件要过 [DO-178C](https://www.faa.gov/documentLibrary/media/Advisory_Circular/AC_20-115D.pdf) 认证，联邦航空局认可的合规审定，要么来自它亲自授权、代表它签字的工程师，要么来自它把这份授权交给的整个机构，两种情况下这个授权都能被收回。扒开法律程序看本质，它跟 Calibre、Questa One 是同一套逻辑，只是换了层监管的外衣，不是技术的外衣。
