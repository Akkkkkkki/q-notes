---
title: "Taste is a bet on a standard that doesn't exist yet"
date: 2026-07-31
excerpt: "I said taste was judgment renamed. Trying to pull the two words apart, I found I could — and the difference is what the moat argument keeps hiding."
...
definedTerm:
  term: "taste"
  pos: "n."
  definition: "judgment aimed at a standard that doesn't exist yet — a call with no wrong answer at the time it's made, settled only when people gradually converge on it."
prediction:
  statement: "The first systems that credibly copy one person's taste arrive as <em>data-collection</em> products — capturing the calls a named individual made and why — rather than as general model improvements."
  confidence: low
  status: open
  falsifier: "if a general model with no person-specific choice data starts matching a named individual's calls in their own domain."
  by: "end of 2028"
sources:
  ...
  - label: "wikipedia.org"
    title: "Hackers & Painters, the collection that essay appears in"
...
Paul Graham's [Taste for Makers](https://paulgraham.com/taste.html) makes the opposite case and makes it well: taste isn't personal preference, and you can tell, because as you get better your old taste doesn't look merely different to you — it looks worse. Preferences that can be wrong in hindsight aren't preferences.
