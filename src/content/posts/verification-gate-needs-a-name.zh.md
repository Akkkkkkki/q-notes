...
有一种可能：真正决定一道验证关卡是不是真的，不管是硬件还是软件，看的不是这个领域改错了能不能挽回，而是跳过它会不会让一个具体的人为此担责。物理验证，至少 Siemens 自己是这么说的，结果就是过或不过。这道检查再往上游走，比如怎么配置、什么才算过，是不是也需要人临场判断，硬件我不懂，说不清楚。但至少这个结果本身，不会像大多数软件评审那样被人争来争去。软件的风险很分散，能一直拖到出事那天才现出原形，这大概也是为什么软件版本的这道关卡一直是潜规则，而不是干脆不存在。
