...
date: 2026-08-20
excerpt: "DAC 2026 上，硬件拿到了真的验证关卡，因为流片错了改不起。软件没有，不是因为软件的错不心疼，是因为跳过检查通常没人担责。"
...
这是我从团队最近一次争论里得出的结论。有同事交代码的时候先说了一句，这是他用 AI 写的，麻烦帮忙看看再上线。就这一句话，团队里吵了起来，吵的是这句话到底该配多少审查。没人有规矩，大家是在当场现造一个。某种程度上，这跟平时看到有人不担责任、把决定推给"流程"，没什么两样。
...
我不同意后半句。改代码从来不是真正的赌注，失败会碰到什么才是。我见过一个客户的代码库，没人把关，AI 随便写，两个半月就变成一团乱麻。每一次改动技术上都能撤销，但整体的乱从来没人真正撤销过，因为没人盯着它是怎么一点点滚起来的。这还只是在浪费工程时间。有些软件故障根本不可逆，碰到安全、隐私、人的生命的那种。git revert 救不了这些，跟救不了一颗错的芯片一样。

有一种可能：真正决定一道验证关卡是不是真的，不管是硬件还是软件，看的不是这个领域改错了能不能挽回，而是跳过它会不会让一个具体的人为此担责。物理验证不用猜，Calibre 过不过就是过不过，没人需要临场判断。软件的风险很分散，能一直拖到出事那天才现出原形，这大概也是为什么软件版本的这道关卡一直是潜规则，而不是干脆不存在。
