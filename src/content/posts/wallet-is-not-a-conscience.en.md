...
An agent-payment system can therefore answer three separate questions: **who is this agent acting for, what is it allowed to spend, and was this specific purchase intended?** In Cloudflare's launch material, the first two have explicit mechanisms. The third does not. The word "trust" by itself does not tell those guarantees apart.
